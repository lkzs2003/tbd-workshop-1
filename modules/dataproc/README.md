...
| <a name="input_preemptible_worker_count"></a> [preemptible\_worker\_count](#input\_preemptible\_worker\_count) | Number of preemptible (spot) worker nodes to add to the Dataproc cluster. Set to 0 to disable. | `number` | `0` | no |
